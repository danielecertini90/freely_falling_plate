...
% non dimensional period of oscillation T, Fig. 1-c
T = 34.1;
...
Y0 = [0.001; 0.001; 0.001; 4*pi/9; -20; -13]; 

% solution of the ODE set
[tSol,ySol] = ode45(@alsomitragliding_3c,tRange,Y0);
...
figure
plot(x_,y_,'k')
title('Fig. 3c Andersen, Pesavento, Wang 2005')
