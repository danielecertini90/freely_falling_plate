...
% non dimensional period of oscillation T, Fig. 1-d
T = 12.1;
...
Y0 = [0.001; 0.001; 0.001; pi/8; -20; 0]; 

% solution of the ODE set
[tSol,ySol] = ode45(@alsomitragliding_3e,tRange,Y0);
...
figure
plot(x_,y_,'k')
title('Fig. 3e Andersen, Pesavento, Wang 2005')
